    ...
    <?php
        ...
        if($result)
        {
            while($row=mysqli_fetch_assoc($result))
            {
                ...
                <th scope="row">'.$fte.'</th>
                <td>
                    <button class="btn btn-primary" style="width: 100px; height: 50px;"><a href="update1.php" style="color: white">update</a></button> 
					<button class="btn btn-danger" style="width: 100px; height: 50px;"><a href="delete.php? deleteid='.$compid.'" class= "text-light"> Delete</a> </button>
                </td>
              </tr>';
            }
        }
    ...
    <?php
        ...
        if($result)
        {
            while($row=mysqli_fetch_assoc($result))
            {
                ...
                <td>'.$placed.'</td>
                <td>
                    <button class="btn btn-primary" style="width: 100px; height: 50px;"><a href="update2.php" style="color: white">Update</a></button>
					<button class="btn btn-danger" style="width: 100px; height: 50px;"><a href="delete1.php? deleteid='.$cid.'" class= "text-light"> Delete</a> </button>
                </td>
              </tr>';
            }
        }
        ...
        if($result)
        {
            while($row=mysqli_fetch_assoc($result))
            {
                ...
                <td>
                    ...
                    <button class="btn btn-primary" style="width: 100px; height: 50px;"><a href="update.php" class="text-light">update</a></button> 
					<button class="btn btn-danger" style="width: 100px; height: 50px;"><a href="delete2.php? deleteid='.$compid.'" class= "text-light"> Delete</a> </button>
